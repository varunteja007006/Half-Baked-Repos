...
import { getMenuList } from "@/lib/config/menu-list";
          ...
          <li className="w-full grow flex items-end">
            {!isAuthenticated ? (
              <TooltipProvider disableHoverableContent>
                <Tooltip delayDuration={100}>
                  <TooltipTrigger asChild>
                    <Button variant="outline" className="w-full justify-center h-10 mt-5" asChild>
                  ...
                  {isOpen === false && <TooltipContent side="right">Sign In</TooltipContent>}
                </Tooltip>
              </TooltipProvider>
            ) : (
              <TooltipProvider disableHoverableContent>
