...
type PhoneInputProps = Omit<React.ComponentProps<"input">, "onChange" | "value" | "ref"> &
  Omit<RPNInput.Props<typeof ReactPhoneNumberInput>, "onChange"> & {
...
>(({ className, onChange, value, defaultCountry, ...props }, ref) => {
  const defaultCountryCode = (process.env.NEXT_PUBLIC_DEFAULT_COUNTRY as RPNInput.Country) || "IN";
  ...
  return (
    <ReactPhoneNumberInput
      ...
      defaultCountry={defaultCountry || defaultCountryCode}
      /**
